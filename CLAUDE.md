...
Code is ground truth: when this section and the code disagree, fix this section.
...
- Sleeve storage change-set 1 (page /storage: CONFIG.TXT editor + verified USB log transfer,
  decisions A-N) built 2026-09-23 on `MSD-management`; plan of record PLAN_msd_management.md
